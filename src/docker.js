 ...
 */
export async function buildImage(contextPath, options = {}) {
 ...
 */
export async function stopContainer(containerNameOrId = DEFAULT_CONTAINER) {
    try {
 ...
 */
export async function isContainerRunning(containerName = DEFAULT_CONTAINER) {
    try {
 ...
 */
export async function getContainerHealth(containerName = DEFAULT_CONTAINER) {
    try {
 ...
 * Get container info
 */
export async function getContainerInfo(containerName = DEFAULT_CONTAINER) {
    try {
 ...
 */
export function streamContainerLogs(containerName = DEFAULT_CONTAINER, onLog) {
