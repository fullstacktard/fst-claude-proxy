"""
claude-proxy server entry point.
...
def main() -> None:
    ...
    logger.info("[server] claude-proxy starting...")
    ...
    # The YAML file has: callbacks: claude_proxy.hooks.callbacks.proxy_callbacks
