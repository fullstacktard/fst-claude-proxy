"""
Combined callbacks for fst-claude-proxy.
...
class FstClaudeProxyCallbacks(CustomLogger):
    """
    Combined callback handler for fst-claude-proxy.
...
proxy_callbacks = FstClaudeProxyCallbacks()
