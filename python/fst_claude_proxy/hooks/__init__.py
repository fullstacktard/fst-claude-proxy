"""
LiteLLM hooks for fst-claude-proxy.
...
from fst_claude_proxy.hooks.agent_routing_hook import agent_routing_callback
from fst_claude_proxy.hooks.oauth_hook import invalidate_credential_cache, oauth_injection_callback
